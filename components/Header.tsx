...
const Header: React.FC<HeaderProps> = ({ theme, toggleTheme, user, onLogout, onLoginClick, onSignupClick, isAdminView, setIsAdminView, onRewardClick, hasRewardAvailable, featureFlags }) => {
